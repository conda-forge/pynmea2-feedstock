...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pynmea2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8258&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pynmea2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pynmea2` can be installed with:

```
conda install pynmea2
```

It is possible to list all of the versions of `pynmea2` available on your platform with:
